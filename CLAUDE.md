...
Constitution **v3.4.0** is authoritative; these summarise it.
...
**`specs/003-curriculum-tracks/plan.md`** — Curriculum tracks and the Grade 10 American Mathematics course
(spec, decisions, research, data-model, contracts, quickstart and tasks sit beside it in the same directory).
`specs/002-identity-and-admin-console/plan.md` is the reference for identity and the console;
`specs/001-student-mvp1-delta/plan.md` for the Student MVP delta.
<!-- SPECKIT END -->
