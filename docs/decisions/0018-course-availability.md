...
**Amended by**: [ADR-0024](./0024-curriculum-as-a-visibility-dimension.md) (2026-09-25, accepted, not committed) — curriculum becomes a dimension of visibility; the (course, grade) rule is unchanged, each course belongs to one curriculum, and the kill switch no longer suspends curriculum scoping
