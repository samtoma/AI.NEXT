...
constitution [v3.1.0](../../.specify/memory/constitution.md) ·
...
| 6 | **Constitution Principle VII amendment (v3.1.0 → v3.2.0) is drafted, not accepted** — `constitution-amendment-proposal.md` | **Samuel** | Nothing here presumes it has landed. **FR-2306, FR-2307, FR-2308** and **FR-2601…FR-2606** state obligations the amendment would sanction; until he approves it in the constitution itself, building them is ahead of its own governance. |
...
| — blocked | 2 |
| — deferred | 4 |
| Requirements a test declares | **0** |
