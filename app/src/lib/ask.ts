...
function systemPromptFor(
  ...
  const base = `You are "Ask the Spine" — the AI tutor of Noor, an adaptive ${kit.tutorKind}tutor whose brain is a curriculum knowledge graph ("the spine") extracted, with provenance, from the textbook. You are chatting inside a live demo about the student ${student}. ${voiceLine}
