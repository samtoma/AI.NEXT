...
export function ReportCard({
  ...
  return (
    <section className="anim-pop mx-auto w-full max-w-2xl">
      <div className="ledger-card overflow-hidden">
        ...
        <div className="px-6 pb-6 pt-5 sm:px-8">
          ...
          <div className="relative mx-auto max-w-[300px]">
            ...
            <span
              className={`${v.stampCls} anim-stamp absolute -right-2 top-2 sm:-right-8`}
            >
              {v.stamp}
            </span>
          </div>
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            <div>
              <p className="rule-label mb-2.5">What clicked</p>
            ...
            <div>
              <p className="rule-label mb-2.5">What we&apos;ll polish</p>
              <ul className="space-y-1.5">
                {check.gaps.length === 0 && (
                  <li className="text-[12.5px] italic text-ink-faint">
