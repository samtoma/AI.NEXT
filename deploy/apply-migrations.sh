...
#
# 31, not 32: the files are numbered 002-032 because 001 was folded into
...
[ "$applied" -ge 31 ] || fail "only $applied migration files were found; this branch has at least 31 (002-032). Is ../db a complete checkout?"
