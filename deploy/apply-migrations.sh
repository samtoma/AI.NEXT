...
#
# 33, not 34: the files are numbered 002-034 because 001 was folded into
...
[ "$applied" -ge 33 ] || fail "only $applied migration files were found; this branch has at least 33 (002-034). Is ../db a complete checkout?"
